...
var activityCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		_, activity := api.GetActivityLogs(cmd, localConfig.APIHost.Value, localConfig.Token.Value)
...
var activityGetCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		_, activity := api.GetActivityLog(cmd, localConfig.APIHost.Value, localConfig.Token.Value, log)
